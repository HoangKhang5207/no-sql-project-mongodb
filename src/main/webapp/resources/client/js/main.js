    ...
    (function () {
        ...
        while (i < sr.length) {
            ...
            sr[i].addEventListener('click', function () {
                ...
                document.querySelector('#rating').value = cs;
                ...
                while (1 <= pre) {
                    ...
                    if (!document.querySelector('.star-' + pre).classList.contains('text-secondary')) {
                        document.querySelector('.star-' + pre).classList.add('text-secondary');
                    }
                ...
                while (5 >= succ) {
                    ...
                    if (document.querySelector('.star-' + succ).classList.contains('text-secondary')) {
                        document.querySelector('.star-' + succ).classList.remove('text-secondary');
                    }
