...
// // public ProductService(ProductRepository productRepository, CartRepository
// // cartRepository,
// // CartDetailRepository cartDetailRepository, OrderRepository
// orderRepository,
...
// Specification<Product> currentSpec =
// ProductSpecs.targetIn(productCriteriaDTO.getTarget().get());
// combinedSpec = combinedSpec.and(currentSpec);
// }
// if (productCriteriaDTO.getFactory() != null &&
// productCriteriaDTO.getFactory().isPresent()) {
// Specification<Product> currentSpec =
// ProductSpecs.factoryIn(productCriteriaDTO.getFactory().get());
// combinedSpec = combinedSpec.and(currentSpec);
// }
// if (productCriteriaDTO.getPrice() != null &&
// productCriteriaDTO.getPrice().isPresent()) {
// Specification<Product> currentSpec =
// this.buildPriceSpecification(productCriteriaDTO,
// productCriteriaDTO.getPrice().get());
// combinedSpec = combinedSpec.and(currentSpec);
// }
...
// // Case 6:
// public Specification<Product> buildPriceSpecification(ProductCriteriaDTO
// productCriteriaDTO, List<String> price) {
...
// // // double min = 10000000;
// // // double max = 15000000;
// // // return this.productRepository.findAll(ProductSpecs.priceRange(min,
// max),
// // // pageable);
...
// this.cartDetailRepository.findByCartAndProduct(cart,
// // realProduct);
...
// // public void handlePlaceOrder(User user, HttpSession session, String
// // receiverName,
