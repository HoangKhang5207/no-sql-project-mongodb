...
public class ProductSpecs {
    ...
    // Case 5:
    public static Specification<Product> priceRange(Double priceMin, Double priceMax) {
    ...
    // Case 6:
    public static Specification<Product> priceMultiRanges(Double priceMin, Double priceMax) {
